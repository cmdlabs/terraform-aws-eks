...
| kiam\_kubelet\_extra\_args | Additional arguments to pass to the kubelet | string | `"--node-labels=spot=true,node-role.kubernetes.io/kiam=true --register-with-taints=node-role.kubernetes.io/kiam=true:NoSchedule"` | no |
